...
export const SocialLink = function () {
  return (
    <ul className={`${styles.app_header__socials} flex`}>
          <li className={styles.app_header__socials_icon_content}>
            <a
              className={styles.app_header__socials_icon_link}
